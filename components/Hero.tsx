  ...
  return (
    <section className="flex flex-col items-center justify-center bg-white-800 px-[5.3125rem] dark:bg-black-300 lg:flex-row">
      <div className="mt-[9.9375rem] flex flex-1 flex-col space-y-6 pb-6">
        <p className="text-[0.875rem] font-semibold uppercase leading-[1.625rem] tracking-[4.2px] text-primary-light dark:text-primary-dark  lg:text-[1.25rem] lg:leading-[1.624rem] lg:tracking-[6px]">
          HI, I AM ALEXANDER
        </p>
        ...
        <p className="text-[0.75rem] font-normal leading-[1.16rem] text-white-500 dark:text-white-800 sm:text-[0.90rem] md:text-[1.125rem] md:leading-[1.8rem]">
