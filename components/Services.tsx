...
const Services: React.FC = async () => {
  ...
  return (
    <section className="flex  flex-col items-center justify-center bg-white-800 px-[5.3125rem] py-[4.5rem] dark:bg-black-300">
      <h2 className="leading-leading4_0rem tracking-tracking_64 mb-[2.5rem] flex flex-row flex-wrap text-[1.6rem] font-bold text-black-200 dark:bg-black-300 dark:text-white-900 vs:justify-center md:text-[3rem]">
        What
        <div className="mx-2">
