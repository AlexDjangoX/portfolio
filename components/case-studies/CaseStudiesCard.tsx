  ...
  return (
    ...
    >
      ...
      <div className="ml-[1.5rem] mt-[1.2rem]">
        <h3 className="text-[1.25rem] font-semibold leading-[1.95rem] text-black-200 dark:text-white-900 ">
          {heading}
        </h3>
        <p className="mt-[0.375rems] text-[0.88rem] font-normal leading-[1.356rem] text-white-500 ">
          {subHeading}
        </p>
      </div>
    </MotionWrapper>
